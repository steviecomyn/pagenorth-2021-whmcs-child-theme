...
<body class="primary-bg-color" data-phone-cc-input="{$phoneNumberInputStyle}">
    ...
    <header id="header" class="header">
        ...
        <style>
            ...
            ul.dropdown-menu {
    background-color: #233469 !important;
}

li.dropdown-item:hover, a.dropdown-item:hover {
...
li.dropdown-item:hover a {
    color: #1e2c55 !important;
        ...
        <div class="navbar navbar-dark navbar-expand-xl main-navbar-wrapper" style="background-color: #1e2c55;">
            <div class="container" style="background-color: #1e2c55;">
                <div class="collapse navbar-collapse" id="mainNavbar" style="background-color: #1e2c55; color: #fff;">
    ...
    <section id="main-body" style="background-color: #fff;">
